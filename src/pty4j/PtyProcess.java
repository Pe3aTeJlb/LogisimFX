...
public abstract class PtyProcess extends Process {
  public abstract void setWinSize(@NotNull pty4j.WinSize winSize);

  public abstract @NotNull pty4j.WinSize getWinSize() throws IOException;
  ...
  public void unloadJNALibraries(){ }
