...
import pty4j.unix.UnixPtyProcess;
import pty4j.windows.CygwinPtyProcess;
import pty4j.windows.WinPtyProcess;
import pty4j.windows.conpty.WinConPtyProcess;
...
public class PtyProcessBuilder {
  ...
  @NotNull
  public pty4j.PtyProcess start() throws IOException {
    if (myEnvironment == null) {
      myEnvironment = System.getenv();
    }
    pty4j.PtyProcessOptions options = new pty4j.PtyProcessOptions(myCommand,
            myEnvironment,
            myDirectory,
