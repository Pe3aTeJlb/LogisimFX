...
package LogisimFX.newgui.MainFrame.SystemTabs.WaveformTab;
...
import LogisimFX.newgui.WaveformFrame.LC;
import LogisimFX.newgui.WaveformFrame.*;
...
public class WaveformController extends AbstractController {
    ...
    public void postInitialization(Stage s, Project proj) {
        ...
        startWaveformBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("startLogging"));
    ...
    private void initSelectionTab(){
        ...
        addBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("selectionAdd"));
        ...
        changRadixBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("selectionChangeBase"));
        ...
        moveUpBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("selectionMoveUp"));
        moveUpBtn.setOnAction(event -> doMove(-1));

        moveDownBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("selectionMoveDown"));
        moveDownBtn.setOnAction(event -> doMove(1));

        removeBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("selectionRemove"));
    ...
    */
    ...
    private void initWaveformTab(){
        ...
        nameColumn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("componentTitle"));
        ...
        valueColumn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("valueTitle"));
        ...
        exportFileBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("saveButton"));
        exportFileBtn.setOnAction(event -> exportLog());

        exportImageBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("exportImage"));
        exportImageBtn.setOnAction(event -> exportImage());

        fileOpenBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("openButton"));
        fileOpenBtn.setOnAction(event -> importLog());
        toElemListBtn.textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding("backToElemList"));
        toElemListBtn.setOnAction(event -> {
            waveformPane.setVisible(false);
            selectionPane.setVisible(true);
        });
    ...
    private static class ToolTip extends Tooltip{
        ...
        public ToolTip(String text){
            super();
            textProperty().bind(LogisimFX.newgui.WaveformFrame.LC.createStringBinding(text));
        }
    ...
    private void updateWaveform(){
        ...
        if(logObjects != null) {
            ...
            gc.fillText(LogisimFX.newgui.WaveformFrame.LC.get("componentTitle"), (hiddenColumnWidth - OldFontmetrics.computeStringWidth(fm, LogisimFX.newgui.WaveformFrame.LC.get("componentTitle"))) / 2, 15);
                ...
                try {
                    ...
                    for (int row = 0; row < tilesY; row++) {
                        ...
                        for (int col = 0; col < tilesX; col++) {
                            ...
                            currTile++;
                            this.updateMessage(LogisimFX.newgui.WaveformFrame.LC.getFormatted("exportProgressHeader",  Integer.toString(currTile), Integer.toString(totalTiles)));
