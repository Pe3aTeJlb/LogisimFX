...
public class FrameManager {
	...
	public static void CreateFPGACommanderCommanderFrame(Project proj) {
		CreateNewFrame("LogisimFX/newgui/FPGAToolchainCommander/FPGAToolchainCommander.fxml", proj, Modality.NONE);
	}

	public static void CreateIOMapperFrame(Project proj) {
		CreateNewFrame("LogisimFX/newgui/IOMapper/IOMapper.fxml", proj, Modality.NONE);
	}
