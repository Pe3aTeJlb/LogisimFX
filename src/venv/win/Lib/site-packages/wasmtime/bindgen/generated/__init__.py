...
class Root:
    ...
    def __init__(self, store: wasmtime.Store, import_object: RootImports) -> None:
        ...
        def lowering0_callee(caller: wasmtime.Caller, arg0: int) -> None:
            import_object.filesystem.drop_descriptor(arg0 & 0xffffffff)
        ...
        def lowering4_callee(caller: wasmtime.Caller) -> int:
        ...
        def lowering8_callee(caller: wasmtime.Caller, arg0: int, arg1: int, arg2: int) -> None:
            ret = import_object.filesystem.write_via_stream(arg0 & 0xffffffff, arg1 & 0xffffffffffffffff)
        ...
        lowering8_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i64(), wasmtime.ValType.i32(), ], [])
        lowering8 = wasmtime.Func(store, lowering8_ty, lowering8_callee, access_caller = True)
        def lowering9_callee(caller: wasmtime.Caller, arg0: int, arg1: int) -> None:
            ret = import_object.filesystem.append_via_stream(arg0 & 0xffffffff)
            if isinstance(ret, Ok):
                payload = ret.value
                ...
                raise TypeError("invalid variant specified for expected")
        lowering9_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
        lowering9 = wasmtime.Func(store, lowering9_ty, lowering9_callee, access_caller = True)
        def lowering10_callee(caller: wasmtime.Caller, arg0: int, arg1: int) -> None:
            ret = import_object.filesystem.get_type(arg0 & 0xffffffff)
            if isinstance(ret, Ok):
                payload = ret.value
                _store(ctypes.c_uint8, self._core_memory0, caller, arg1, 0, 0)
                ...
                raise TypeError("invalid variant specified for expected")
        lowering10_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
        ...
        lowering11_ty = wasmtime.FuncType([wasmtime.ValType.i64(), wasmtime.ValType.i32(), ], [])
        ...
        def lowering13_callee(caller: wasmtime.Caller, arg0: int, arg1: int, arg2: int, arg3: int) -> None:
            ptr = arg1
            len0 = arg2
            ...
            if isinstance(ret, Ok):
                ...
                _store(ctypes.c_uint64, self._core_memory0, caller, arg3, 8, _clamp(payload, 0, 18446744073709551615))
            elif isinstance(ret, Err):
                payload1 = ret.value
                _store(ctypes.c_uint8, self._core_memory0, caller, arg3, 0, 1)
            else:
                raise TypeError("invalid variant specified for expected")
        lowering13_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
